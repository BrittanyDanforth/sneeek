--[[
	Updated Purchase Handler (2025 Standards) - Fresh Version
	Handles tycoon purchases and money collection with smooth animations
	Fixed: Part flinging issue, added smooth fade effects
--]]
...
print("✅ Updated Purchase Handler loaded successfully!")