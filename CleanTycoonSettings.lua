--[[
	CLEAN TYCOON SETTINGS MODULE
	This has NO requires = NO recursive errors!
	Place this as "Settings" inside each tycoon folder
]]
...
-- Steal Settings (used by PurchaseHandler)
