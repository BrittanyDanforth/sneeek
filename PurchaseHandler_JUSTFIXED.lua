--[[
	...
	- USES DEPENDENCY SYSTEM (not PROGRESSION_DATA)
	- FIXED SETTINGS LOADING FOR LIVE GAMES
--]]
...
-- Update button colors based on money (dependency system handles visibility)
