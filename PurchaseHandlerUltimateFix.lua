--[[
	✨ Clean Purchase Handler - ULTIMATE FIXED Version
...
print("✅ Purchase Handler ULTIMATE FIXED loaded!")
print("🔄 Dependencies now check for spawned objects, not button names")
print("📋 Properly resets and re-initializes everything")
